...
## 2026-08-16
- **Update** [formatting](/display/formatting.md) — Pivot history bars are stacked per-tool (largest-remainder apportionment, cyan/magenta/blue/green palette by column order, 5th+ uncolored); yellow reserved for overflow; footer legend when bars+≥2 tools+color; colors.ts gains magenta/blue/colorDisabled (3tah)
