...
## 2026-06-10
- **Update** [data-pipeline](/cli/data-pipeline.md) — fix: Fix Metrics History Destruction & Self-Exclusion Blind Spot (#34)
...
## 2026-05-31
- **Update** [data-pipeline](/cli/data-pipeline.md) — feat: add --skip-brew-update flag to update command (#24)
...
## 2026-05-09
- **Update** [data-pipeline](/cli/data-pipeline.md) — chore: tu: rename 'completions' subcommand to 'shell-init' (#18)

## 2026-04-23
- **Update** [data-pipeline](/cli/data-pipeline.md) — feat: execFile migration, CSV/MD export, shell completions
...
## 2026-04-03
- **Update** [data-pipeline](/cli/data-pipeline.md) — feat: Add -v Version Shorthand (#12)

## 2026-04-01
- **Update** [data-pipeline](/cli/data-pipeline.md) — Added `-v` (lowercase) as version flag alias alongside `--version` and `-V` (kuuh)

## 2026-03-07
- **Update** [data-pipeline](/cli/data-pipeline.md) — feat: Add --by-machine flag (#7)
- **Update** [data-pipeline](/cli/data-pipeline.md) — fix: `-u` flag returns stale data when targeting same user (#6)
- **Update** [data-pipeline](/cli/data-pipeline.md) — feat: Add Self-Update Command (#5)
- **Update** [data-pipeline](/cli/data-pipeline.md) — fix: Filter Usage by User (#4)
...
## 2026-03-06
- **Update** [data-pipeline](/cli/data-pipeline.md) — Reorganize src/ into node namespace with core/tui/sync subdirs
- **Creation** [data-pipeline](/cli/data-pipeline.md) — Hydrating docs
