...
import { printHistory, printTotal, printTotalHistory, renderHistory, renderTotal, renderTotalHistory } from "./formatter.js";
...
import { writeMetrics, readRemoteEntries, fullSync } from "./sync.js";
...
const PKG_VERSION = JSON.parse(readFileSync(join(__cli_dirname, "..", "package.json"), "utf-8")).version as string;
